...
//   if (module.type === "%") module.state = "high";
//   else if (module.type === "&")
//     for (const key of module.inputs.keys()) module.inputs.set(key, "high");
...
for (let i = 0; i < Infinity; i++) {
  ...
  // console.log(
  //   [...graph.keys()]
  //     // .sort((moduleA, moduleB) => moduleA.name.localeCompare(moduleB.name))
  //     .map((module) => (module.type === "%" ? module.state : undefined))
